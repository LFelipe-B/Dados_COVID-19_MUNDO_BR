...
labels = c("BR (Brasil): 2985 casos","CH (China): 81782 casos", "ES (Espanha): 57786 casos","FR (França): 29155 casos","IT (Itália): 80589 casos","JP (Japão): 1387 casos", "US (Estados Unidos): 83836 casos", "ZA (África do Sul): 927 casos"))+
